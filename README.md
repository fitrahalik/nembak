...
<html lang="en">
  <head>
    ...
    <title>Website Bucin - Fitra Halik Jourdy</title>
    <style>
      body {
  ...
  <body class="justify-center flex">
    ...
    >
      ...
      <div class="lh-1 text-center mt-4">
        ...
        <!-- ganti pertanyaan -->
        <p class="title question fs-1 text-2xl font-bold text-gray-700">mau jadi pacarku ga?</p>
      </div>
      ...
      <div class="numbers hidden mt-5 flex justify-center">
        <!-- ganti link -->
        <a
          href="https://wa.me/6281388511899"
          type="button"
